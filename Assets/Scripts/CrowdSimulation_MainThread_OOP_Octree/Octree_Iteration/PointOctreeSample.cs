...
public class PointOctreeSample : MonoBehaviour
{
    ...
    public BoundsOctree<GameObject> boundsOctree;

    public float SizeLength = 20f;
    ...
    private void Start()
    {
        pointOctree = new PointOctree<GameObject>(SizeLength, transform.position, 1f);
        //boundsOctree = new BoundsOctree<GameObject>(SizeLength, transform.position, 1f, 1f);
